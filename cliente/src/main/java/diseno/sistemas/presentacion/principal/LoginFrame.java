...
public class LoginFrame extends javax.swing.JFrame {
	...
	private void initGUI() {
		try {
			...
			getContentPane().setLayout(thisLayout);
			{
				...
				lblSapo.addKeyListener(new KeyAdapter() {
			...
			}
			{
				...
				panelFormLayout.columnWeights = new double[] { 0.0, 0.0, 0.1,
						0.0 };
				...
				panelForm.setLayout(panelFormLayout);
				{
					...
					panelForm.add(txtxCuenta, new GridBagConstraints(2, 1, 1,
							1, 0.0, 0.0, GridBagConstraints.CENTER,
							GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0,
									0), 0, 0));
					txtxCuenta.setName("txtxCuenta");
					txtxCuenta.addActionListener(new ActionListener() {
				...
				}
				{
					...
					panelForm.add(txtPassword, new GridBagConstraints(2, 2, 1,
							1, 0.0, 0.0, GridBagConstraints.CENTER,
							GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0,
									0), 0, 0));
				...
				}
				{
					...
					panelForm.add(lblCuenta, new GridBagConstraints(0, 1, 1, 1,
				...
				}
				{
					...
					panelForm.add(lblPassword, new GridBagConstraints(0, 2, 1,
			...
			}
			{
				...
				btnIngresar.setAction(getAppActionMap().get(
						"iniciarSesionAction"));
			}
			pack();
			setSize(400, 300);
	...
	public void iniciarSesionAction() {
		if (validar()) {
			...
			usuario.setCuenta(txtxCuenta.getText());
	...
	public boolean validar() {
		...
		if(txtxCuenta.getText()!=null && !txtxCuenta.equals("")){
